...
2. **Refactoring the Code** (*Meeting Accessiblity Standards*)
    ...
    - Continuing to look through the index file I grew frustrated with the fact that I just couldn't figure out how to condense a lot of the <div><ul><li> elements in the <header> section of the index.
        - 